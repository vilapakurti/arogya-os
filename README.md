...
All AI features (report analysis, Doctor Copilot brief, Ask Doctor Copilot chat) route through a single backend module (`src/convex/aiProvider.ts`) with this priority:
